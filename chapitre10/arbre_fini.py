...
class arbre:
    ...
    def recherche_profondeur(self, valeur):
        """Type->noeud
            Renvoie un booléen correspondant au fait que la valeur soit dans l'arbre ou pas"""
        if self.__racine.Lire_fd()==None and self.__racine.Lire_fg()==None :
            return self.__racine.Lire_valeur()==valeur
        elif self.__racine.Lire_fd()==None :
            return ((self.__racine.Lire_valeur()==valeur) or (self.sous_arbre(self.__racine.Lire_fg()).recherche_profondeur(valeur)==valeur))
        elif self.__racine.Lire_fg()==None : 
            return ((self.__racine.Lire_valeur()==valeur) or (self.sous_arbre(self.__racine.Lire_fd()).recherche_profondeur(valeur)==valeur))
        else :
            print(self.__racine.Lire_valeur()==valeur)
            return ((self.__racine.Lire_valeur()==valeur) or (self.sous_arbre(self.__racine.Lire_fg()).recherche_profondeur(valeur)==valeur) or (self.sous_arbre(self.__racine.Lire_fd()).recherche_profondeur(valeur)==valeur))
...
if __name__ == "__main__":
    ...
    print(a.suffixe())
    print(a.largeur())
    print(a.recherche_profondeur(10))